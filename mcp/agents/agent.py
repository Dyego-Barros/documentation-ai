...
class Agent:
    ...
    async def gerar_docstring_Python(self,code: str) -> str:
    ...
    async def gerar_docstring_csharp(self,code: str) -> str:
        response =  await self.client.chat.completions.create(
            #model="Qwen2.5-VL-3B-Instruct-Q4_K_M.gguf",
            model=os.getenv("GROQ_MODEL"),
            messages=[
    ...
    async def gerar_docstring_java(self,code: str) -> str:
        response = await self.client.chat.completions.create(
            #model="Qwen2.5-VL-3B-Instruct-Q4_K_M.gguf",
            model=os.getenv("GROQ_MODEL"),
            messages=[
    ...
    async def gerar_docstring_javascript(self,code: str) -> str:
        response = await self.client.chat.completions.create(
            #model="Qwen2.5-VL-3B-Instruct-Q4_K_M.gguf",
            model=os.getenv("GROQ_MODEL"),
            messages=[
        ...
        return response.choices[0].message.content.strip()
    async def gerar_docstring_go(self,code: str) -> str:
        response =  await self.client.chat.completions.create(
            #model="Qwen2.5-VL-3B-Instruct-Q4_K_M.gguf",
            model=os.getenv("GROQ_MODEL"),
            messages=[
    ...
    async def gerar_dockerfile(self,context: dict) -> str:
        response = await self.client.chat.completions.create(
            #model="Qwen2.5-VL-3B-Instruct-Q4_K_M.gguf",
            model=os.getenv("GROQ_MODEL"),
            messages=[
    ...
    async def gerar_compose(self, services: list) -> str:
        response =  await self.client.chat.completions.create(
            #model="Qwen2.5-VL-3B-Instruct-Q4_K_M.gguf",
            model=os.getenv("GROQ_MODEL"),
            messages=[
